  ...
  `}customElements.define("rm-recipe-detail",de);class pe extends ne{static properties={api:{type:Object},_mode:{type:String},_url:{type:String},_scraping:{type:Boolean},_scrapeError:{type:String},_form:{type:Object},_saving:{type:Boolean},_ingredientInput:{type:String},_importFile:{type:Object},_importing:{type:Boolean},_importResult:{type:Object},_importError:{type:String},_importDownloadImages:{type:Boolean}};constructor(){super(),this.api=null,this._mode="url",this._url="",this._scraping=!1,this._scrapeError=null,this._saving=!1,this._ingredientInput="",this._form=this._emptyForm(),this._importFile=null,this._importing=!1,this._importResult=null,this._importError=null,this._importDownloadImages=!0}_emptyForm(){return{name:"",description:"",source_url:"",servings:4,prep_time:"",cook_time:"",tags:"",notes:"",image_url:"",ingredients:[],instructions:[]}}_close(){this.dispatchEvent(new CustomEvent("rm-close",{bubbles:!0,composed:!0}))}async _handleScrape(){if(this._url.trim()&&!this._scraping){this._scraping=!0,this._scrapeError=null;try{const e=await this.api.scrapeRecipe(this._url.trim());if(e?.recipe){const t=e.recipe;this._form={name:t.name||"",description:t.description||"",source_url:t.source_url||this._url.trim(),servings:t.servings||4,prep_time:t.prep_time||"",cook_time:t.cook_time||"",tags:(t.tags||[]).join(", "),notes:t.notes||"",image_url:t.image_url||"",ingredients:t.ingredients||[],instructions:t.instructions||[]},this._mode="manual"}else this._scrapeError=e?.error||"Could not extract recipe from this URL."}catch(e){this._scrapeError=e.message||"Scraping failed."}finally{this._scraping=!1}}}_handleImportFileChange(e){this._importFile=e.target.files[0]||null,this._importResult=null,this._importError=null}async _handleImport(){if(this._importFile&&!this._importing){this._importing=!0,this._importResult=null,this._importError=null;try{const e=await new Promise((e,t)=>{const i=new FileReader;i.onload=()=>{const t=i.result,r=t.indexOf(",");e(r>=0?t.slice(r+1):t)},i.onerror=t,i.readAsDataURL(this._importFile)}),t=await this.api.importRecipeKeeper(e,this._importDownloadImages);this._importResult=t,t.imported>0&&this.dispatchEvent(new CustomEvent("rm-import-done",{bubbles:!0,composed:!0}))}catch(e){this._importError=e.message||"Import failed."}finally{this._importing=!1}}}async _handleSave(){if(this._form.name.trim()&&!this._saving){this._saving=!0;try{const e={...this._form,servings:parseInt(this._form.servings)||4,prep_time:parseInt(this._form.prep_time)||null,cook_time:parseInt(this._form.cook_time)||null,tags:this._form.tags?this._form.tags.split(",").map(e=>e.trim()).filter(Boolean):[]};this.dispatchEvent(new CustomEvent("rm-add-recipe",{detail:{data:e},bubbles:!0,composed:!0}))}finally{this._saving=!1}}}_setField(e,t){this._form={...this._form,[e]:t}}_addIngredient(){const e=this._ingredientInput.trim();if(!e)return;const t=e.split(/\s+/);let i="",r="",s="";t.length>=3&&!isNaN(parseFloat(t[0]))?(i=t[0],r=t[1],s=t.slice(2).join(" ")):2!==t.length||isNaN(parseFloat(t[0]))?s=e:(i=t[0],s=t[1]),this._form={...this._form,ingredients:[...this._form.ingredients,{amount:i,unit:r,name:s}]},this._ingredientInput=""}_removeIngredient(e){const t=this._form.ingredients.filter((t,i)=>i!==e);this._form={...this._form,ingredients:t}}_addStep(e){e.trim()&&(this._form={...this._form,instructions:[...this._form.instructions,e.trim()]})}_removeStep(e){const t=this._form.instructions.filter((t,i)=>i!==e);this._form={...this._form,instructions:t}}render(){return H`
    ...
    `}_renderImportMode(){return H`
      <div class="import-mode">
        ...
        ${this._importResult?H`
          <div class="import-result ${this._importResult.failed>0?"partial":"success"}">
            ...
            <div>
              ...
              ${this._importResult.failed>0?H`<br/><small>${this._importResult.failed} failed — check HA logs for details</small>`:""}
            </div>
          </div>
        `:this._importError?H`
        ...
        >
          ${this._importing?H`<ha-circular-progress active size="tiny"></ha-circular-progress> Importing…`:H`<ha-icon icon="mdi:import"></ha-icon> Import Recipes`}
        </button>
      </div>
